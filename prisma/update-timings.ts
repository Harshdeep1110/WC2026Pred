...
async function main() {
  ...
  const corrections: [string, string, string, number, number][] = [
    ...
    // === ROUND OF 32 ===
    ['Winner C', 'Runner-up F', '2026-06-29', 22, 30],
    ['Runner-up A', 'Runner-up B', '2026-06-30', 0, 30],
    ['Winner E', 'Third Place A/B/C/D/F', '2026-06-30', 2, 0],
    ['Winner F', 'Runner-up C', '2026-06-30', 6, 30],
    ['Runner-up E', 'Runner-up I', '2026-06-30', 22, 30],
    ['Winner I', 'Third Place C/D/F/G/H', '2026-07-01', 2, 30],
    ['Winner A', 'Third Place C/E/F/H/I', '2026-07-01', 6, 30],
    ['Winner L', 'Third Place E/H/I/J/K', '2026-07-01', 21, 30],
    ['Winner D', 'Third Place B/E/F/I/J', '2026-07-02', 5, 30],
    ['Winner H', 'Runner-up J', '2026-07-02', 5, 30],
    ['Winner K', 'Runner-up L', '2026-07-03', 0, 0],
    ['Runner-up H', 'Runner-up J', '2026-07-03', 0, 0],
    ['Winner J', 'Runner-up H', '2026-07-03', 3, 30],
    ['Winner B', 'Third Place E/F/G/J', '2026-07-03', 8, 30],
    ['Runner-up D', 'Runner-up G', '2026-07-03', 23, 30],
    ['Winner K', 'Third Place D/E/I/J/L', '2026-07-04', 7, 0],
